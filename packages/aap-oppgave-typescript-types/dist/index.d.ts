        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["no.nav.aap.oppgave.enhet.EnhetsoppdateringRapport"];
                    };
                };
            };
        };
...
interface components {
    schemas: {
        ...
        "no.nav.aap.behandlingsflyt.kontrakt.hendelse.BehandlingFlytStoppetHendelse": {
            ...
            /**
             * Format: date-time
             * @example 2025-01-10T07:42:33.350488391
             */
        ...
        "no.nav.aap.oppgave.OppgaveOgPerson": {
        ...
        "no.nav.aap.oppgave.enhet.EnhetsoppdateringRapport": {
            /** Format: int32 */
            antallOppgaverUtenEnhet: number;
            oppgaveOgPersonListe: components["schemas"]["no.nav.aap.oppgave.OppgaveOgPerson"][];
        };
