...
export enum NoNavAapBehandlingsflytKontraktHendelseBehandlingFlytStoppetHendelseRsakTilOpprettelse {
...
export enum NoNavAapOppgaveEnhetNVRendeEnhetOppgaveKategori {
    BESLUTTER = "BESLUTTER",
    KVALITETSSIKRING = "KVALITETSSIKRING",
