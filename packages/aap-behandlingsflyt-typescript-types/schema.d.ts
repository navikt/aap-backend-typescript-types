...
export interface paths {
    ...
    "/api/dokumentinnhenting/syfo/purring/{behandlingsreferanse}/{dialogmeldinguuid}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: {
            parameters: {
                ...
                path: {
                    ...
                    /** @description behandlingsreferanse */
    ...
    "/api/hendelse/send": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["no.nav.aap.behandlingsflyt.flyt.flate.MottattHendelseDto"];
                };
            };
            responses: {
                /** @description OK */
...
export interface components {
    schemas: {
        ...
        "no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.flate.Historikk": {
            ...
            /**
             * Format: date-time
             * @example 2024-11-22T13:47:37.356615439
             */
            tidspunkt: string;
        };
        ...
        "no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.l\u00F8ser.vedtak.TotrinnsVurdering": {
            ...
            /** @enum {string} */
            definisjon: "9001" | "9002" | "9003" | "5001" | "5003" | "5004" | "5005" | "5006" | "5007" | "5008" | "5009" | "5010" | "5011" | "5012" | "5013" | "5014" | "5097" | "5098" | "5099" | "5050";
        ...
        "no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.l\u00F8sning.AvklarBarnetilleggL\u00F8sning": {
            /** @enum {string} */
            behovstype: "9001" | "9002" | "9003" | "5001" | "5003" | "5004" | "5005" | "5006" | "5007" | "5008" | "5009" | "5010" | "5011" | "5012" | "5013" | "5014" | "5097" | "5098" | "5099" | "5050";
        ...
        "no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.MottattDokumentReferanse": {
            "asAvvistLegeerkl\u00E6ringId": components["schemas"]["no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.dokumentinnhenting.AvvistLegeerkl\u00E6ringId"];
            asInnsendingId: components["schemas"]["no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.arbeid.InnsendingId"];
        ...
        "no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.arbeid.InnsendingId": {
            asString: string;
            /** Format: uuid */
            value: string;
        };
        "no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.dokumentinnhenting.AvvistLegeerkl\u00E6ringId": {
            asString: string;
            /** Format: uuid */
            value: string;
        };
        ...
        "no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.kontrakt.aktivitet.HammerDto": {
            ...
            dato: string;
            /** @enum {string} */
            type: "IKKE_MØTT_TIL_MØTE" | "IKKE_MØTT_TIL_BEHANDLING" | "IKKE_MØTT_TIL_TILTAK" | "IKKE_MØTT_TIL_ANNEN_AKTIVITET" | "IKKE_SENDT_INN_DOKUMENTASJON" | "IKKE_AKTIVT_BIDRAG";
        };
        ...
        "no.nav.aap.behandlingsflyt.flyt.flate.MottattHendelseDto": {
            /** @enum {string} */
            kanal: "DIGITAL" | "PAPIR";
            payload?: components["schemas"]["kotlin.Any"];
            referanse: components["schemas"]["no.nav.aap.behandlingsflyt.faktagrunnlag.dokument.MottattDokumentReferanse"];
            saksnummer: string;
            /** @enum {string} */
            type: "SØKNAD" | "AKTIVITETSKORT" | "PLIKTKORT" | "UKJENT" | "LEGEERKLÆRING_MOTTATT" | "LEGEERKLÆRING_AVVIST" | "DIALOGMELDING";
        };
        ...
        "no.nav.aap.behandlingsflyt.flyt.flate.Vilk\u00E5rDTO": {
            ...
            /** @enum {string} */
            "vilk\u00E5rtype": "ALDERSVILKÅRET" | "SYKDOMSVILKÅRET" | "BISTANDSVILKÅRET" | "MEDLEMSKAP" | "GRUNNLAGET" | "SYKEPENGEERSTATNING" | "STUDENTVILKÅRET";
        };
        ...
        "no.nav.aap.behandlingsflyt.kontrakt.avklaringsbehov.Definisjon": {
            /** @enum {string} */
            kode: "9001" | "9002" | "9003" | "5001" | "5003" | "5004" | "5005" | "5006" | "5007" | "5008" | "5009" | "5010" | "5011" | "5012" | "5013" | "5014" | "5097" | "5098" | "5099" | "5050";
