...
export interface paths {
    ...
    "/api/soknad/send": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["no.nav.aap.behandlingsflyt.flyt.S\u00F8knadSendDto"];
                };
            };
            responses: {
                /** @description OK */
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["no.nav.aap.behandlingsflyt.flyt.AlleHammereDto"];
                    };
                };
            };
        };
    ...
    "/api/aktivitetsplikt/{saksnummer}/v2/oppdater": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.OppdaterAktivitetspliktDTOV2"];
                };
            };
            responses: {
                /** @description OK */
    ...
    "/api/hendelse/send": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["no.nav.aap.behandlingsflyt.kontrakt.hendelse.MottattHendelseDto"];
                };
            };
            responses: {
                /** @description OK */
...
export interface components {
    schemas: {
        ...
        "no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.flate.Historikk": {
            ...
            /**
             * Format: date-time
             * @example 2024-12-09T09:34:56.484464548
             */
            tidspunkt: string;
        };
        ...
        "no.nav.aap.behandlingsflyt.faktagrunnlag.register.barn.OppgitteBarn": {
            /** Format: int64 */
            id?: number | null;
            identer: components["schemas"]["no.nav.aap.behandlingsflyt.sakogbehandling.Ident"][];
        };
        ...
        "no.nav.aap.behandlingsflyt.flyt.AlleHammereDto": {
        ...
        "no.nav.aap.behandlingsflyt.flyt.S\u00F8knadSendDto": {
            journalpostId: string;
            saksnummer: string;
        ...
        "no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.BruddAktivitetspliktHendelseDto": {
            ...
            periode: components["schemas"]["no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.PeriodeDTO"];
        };
        ...
        "no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.OpprettAktivitetspliktDTO": {
            ...
            perioder: components["schemas"]["no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.PeriodeDTO"][];
        };
        "no.nav.aap.behandlingsflyt.hendelse.bruddaktivitetsplikt.PeriodeDTO": {
            /**
             * Format: date
             * @example 2024-12-09
             */
        ...
        "no.nav.aap.behandlingsflyt.kontrakt.hendelse.MottattHendelseDto": {
            hendelseId: components["schemas"]["no.nav.aap.behandlingsflyt.kontrakt.hendelse.InnsendingReferanse"];
            /** @enum {string} */
            kana: "DIGITAL" | "PAPIR";
